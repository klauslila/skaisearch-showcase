...
**15.5M+** price observations · **1.62M+** flights · **1,460k+** logged query attempts ·
...
The promoted model scores **R² 0.82** against a **0.56** median baseline at **14.9%** error, fitted on
151,081 rows across 400 trees. Each figure is the median of 4 separate 14-day runs, so one lucky window can't carry it. Pushed to **49 days out** it scores **R² 0.74** at **20.4%** error. Gain by feature:

| Feature | Gain | Feature | Gain |
|---|---|---|---|
| Trip type | ██████████ 41.7% | Climate season | ▌ 2.4% |
| Distance / haul | █████▌ 23.2% | Source | ▎ 1.5% |
