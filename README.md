...
**15.7M+** price observations · **1.64M+** flights · **1,480k+** logged query attempts ·
**2,100+** collection runs · **36** active routes · **28** airports · **7.3 GB** on disk ·
...
The promoted model scores **R² 0.81** against a **0.56** median baseline at **14.9%** error, fitted on
152,536 rows across 400 trees. Each figure is the median of 4 separate 14-day runs, so one lucky window can't carry it. Pushed to **49 days out** it scores **R² 0.73** at **19.7%** error. Gain by feature:

| Feature | Gain | Feature | Gain |
|---|---|---|---|
| Trip type | ██████████ 42.8% | Climate season | ▌ 2.3% |
| Distance / haul | █████▍ 23.3% | Source | ▎ 1.3% |
| Destination | ███▌ 15.0% | Lead time (days) | ▏ 1.0% |
| Stops | █▎ 5.4% | Carriers | ▏ 0.8% |
